...
public class ImageCompressUtil {
     ...
     * @return 压缩后的图片
     */
    public static Bitmap compressByQuality(Bitmap bitmap, int maxSize,int targetWidth,
                                           int targetHeight,ByteArrayOutputStream baos) {
//        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        ...
        while (baos.toByteArray().length / 1024 > maxSize && maxSize>10) {
            quality -= 10;
            baos.reset();
            bitmap.compress(Bitmap.CompressFormat.JPEG, quality, baos);
